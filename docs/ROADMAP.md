...
- Recurring defaults (#18): restricted expense-category configuration, read-only pending previews, and explicit funded initialization are implemented locally in Migration 018. Production Migration 018 remains unexecuted.
- Next dependent work remains separate: monthly overrides (#19), carryover (#20), unused-budget/savings disposition (#21), unbudgeted-expense behavior (#22), reallocation/deficit resolution (#23), and the funded summary UX (#25).
