...
- Month overrides (#19): current/future month-only base configuration, immutable funded adjustments, override-aware initialization, carryover-safe composition, and explicit Budget-page actions are implemented locally in Migration 020. Production Migration 020 remains unexecuted.
- Next dependent work remains separate: unused-budget/savings disposition (#21), unbudgeted-expense behavior (#22), reallocation/deficit resolution (#23), and the funded summary UX (#25).
