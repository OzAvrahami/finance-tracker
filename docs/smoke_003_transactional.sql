...
-- If the SQL Editor reports a real syntax/execution error and this script does
-- not reach its final ROLLBACK, immediately open a NEW SQL Editor query and run:
--
--   ROLLBACK;
--
...
-- so later checks and the final ROLLBACK can still run.
-- =============================================================================
...
-- Main smoke-test result set. Every row should say PASS.
SELECT check_order,
...
-- Compact summary. Expect failed=0.
...
--
-- These statements run after ROLLBACK. Every row should say PASS, proving the
-- index and functions created inside the transaction did not remain.
-- =============================================================================
